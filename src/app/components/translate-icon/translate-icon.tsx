...
export const TranslateIcon = ({ id, sentence }: DataProps) => {
      ...
      >
        <g id="_xD83D__xDDA5_-Welab.bank-pre-launch-desktop">
          <g id="_x31_" transform="translate(-1066.000000, -38.000000)">
            <path
              id="Fill-1"
              className="fill-rule:evenodd;clip-rule:evenodd;fill:#010202;"
              d="M1420.7,284.1c-5-6.7-8.3-12.7-10.3-17.1h20.6C1429,271.4,1425.8,277.3,1420.7,284.1
